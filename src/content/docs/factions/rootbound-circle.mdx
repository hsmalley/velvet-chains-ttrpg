---
title: The Rootbound Circle
description: Soulmarked convergence seeking to rewrite planar memory.
entryType: faction
id: rootbound-circle
...
The Rootbound Circle is not a cult—at least not in the traditional sense. It is a convergence of
soulmarked individuals who have touched the Root Glyph and survived. They do not worship it. They
become it.

Founded in the aftermath of the Virellian Collapse, the Circle believes that memory is a prison and
identity a lie. Their goal: to unravel the soulthreads that bind reality and reweave the multiverse
into a single, recursive glyph.

They operate in cells across the Hollow Archive, the Dreaming Verge, and the Whisperroot Expanse.
Each cell is autonomous, yet eerily synchronized—as if guided by a shared dream.

---

### 🧠 Beliefs & Practices

- **Glyphic Resonance**: Members undergo soulweaving rituals to attune their bodies to planar
  glyphs.
- **Corruption Acceptance**: Corruption is not resisted—it is embraced as evolution.
- **Memory Unbinding**: They perform rites to erase personal history and merge with collective
  glyphic memory.
